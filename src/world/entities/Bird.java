...
public class Bird extends Entity {
    ...
    public Bird(Location location) {
        ...
        super(location, EntityType.BIRD);
        this.color = new Color((int)(Math.random() * 0), (int)(Math.random() * 0), (int)(Math.random() * 0), alpha);
    }
    ...
    public void tick(){
        ...
        if(Math.random() < 0.02){
            sideRotation += Math.toRadians(Math.random() * 80);
        }
        if(Math.random() < 0.02){
            sideRotation -= Math.toRadians(Math.random() * 80);
        }
        if(Math.random() < 0.0001){
            verticalRotation += Math.toRadians(Math.random() * 10);
        }
        if(Math.random() < 0.0001){
            verticalRotation -= Math.toRadians(Math.random() * 10);
        }
